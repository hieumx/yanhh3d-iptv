...
def main():
    parser = argparse.ArgumentParser(description="Scrape Ophim for IPTV")
    parser.add_argument('-f', '--file', default='ophim_movies.txt', help='File containing Ophim movie slugs')
        ...
        with open(args.file, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                if line and not line.startswith('#'):
                    ...
                    if 'ophim1.com/phim/' in line:
                        slug = line.split('ophim1.com/phim/')[-1].strip('/')
                    elif '/' in line:
    ...
    latest_data = fetch_api('https://ophim1.com/danh-sach/phim-moi-cap-nhat?page=1')
    ...
    with open(args.output, mode, encoding='utf-8') as f:
        ...
        for slug in slugs:
            print(f"Processing Ophim movie: {slug}")
            data = fetch_api(f"https://ophim1.com/phim/{slug}")
